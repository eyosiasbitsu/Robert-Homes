...
const defaultPropertyType: ClassOfProperties[] = [
  {
    name: "Duplex House",
    description: "A multi-family home with two separate living units for sale.",
    checked: true,
  },
  {
    name: "Ferme House",
    description:
      "A spacious farmhouse-style property perfect for families looking to buy.",
    checked: false,
  },
  {
    name: "Chalet House",
    description:
      "A cozy wooden house, typically located in mountain regions, available for purchase.",
    checked: false,
  },
  {
    name: "Maison House",
    description:
      "A luxurious and spacious home designed for comfortable living and ownership.",
    checked: false,
  },
];
